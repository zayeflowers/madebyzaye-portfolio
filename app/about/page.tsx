    ...
    <PageLayout navbarKey="navbar-about">
      ...
      <section className="gutter pb-[64px] max-sm:pb-[32px] grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-[48px] lg:gap-[64px] items-start">
        <div className="prose-zaye measure">
          ...
          <p>
            Today I&apos;m focused on <strong>Before Us</strong>, a daily-quote app of
            Black American and Black Diaspora voices, and <strong>UX Strip</strong>, a
            comic series about the absurd side of product work. Both combine my passion
