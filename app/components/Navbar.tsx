  ...
  return (
    <nav className="w-full bg-white border-b border-gray-100">
      <Container className="flex flex-row items-center justify-between">
        ...
        <div className="hidden md:flex flex-wrap items-center justify-end gap-4 sm:gap-6 md:gap-10 py-4 md:py-0 w-full md:w-auto md:h-[128px] md:items-center">
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden bg-white w-full border-t border-gray-100 py-4 ${mobileMenuOpen ? 'block' : 'hidden'}`}>
        <Container>
