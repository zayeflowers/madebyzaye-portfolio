      ...
      <main className="w-full bg-[#f6f0e9] text-black pt-[16px] pb-24 min-h-screen relative">
        ...
        <Container>
          ...
          <p className="text-xl font-[family-name:var(--font-montserrat)] font-medium mb-8 text-[#CC0101]">
            Reimagining hospitality digital experiences
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div>
              <h2 className="font-[family-name:var(--font-montserrat)] font-bold text-xl mb-2">Role</h2>
              <p className="font-[family-name:var(--font-montserrat)] leading-[28px]">UX/UI Designer</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-[family-name:var(--font-montserrat)] leading-[28px]">Sketch, InVision, Adobe Creative Suite</p>
            </div>
          </div>
